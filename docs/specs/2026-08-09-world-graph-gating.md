# 시스템 기획서 ① — 월드 그래프 · 게이팅 · 복귀

> ## 상태: **재제출본 rev.2 — `design-critic` REVISE(12건) 대응 완료 · 오너 미승인**
...
| `docs/specs/2026-08-09-progression-spine.md` | 막 = 신앙 4단계 · 하드 게이트 = 성물 3 · 세계 상태 변화 규칙(§4) · 되돌아올 수 없는 지점(§3-終) |
| `docs/specs/2026-08-09-world-route.md` | 장소 목록·순서·방 배분 ≈120 **(A-7 판정 대기 — 이 문서는 그 표의 *구조*만 쓰고 *내용*은 안 쓴다)** |
